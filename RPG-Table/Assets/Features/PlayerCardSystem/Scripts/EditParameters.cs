...
public class EditParameters : MonoBehaviour, IUIBehavior
{
   ...
   private void Awake()
    ...
    void clearData()
    {
        ...
        EditParametersPanel.transform.Find("TransparencyPanel/TransparencyPlace").GetComponent<TMP_InputField>().text = "";
        EditParametersPanel.transform.Find("IMGPanel/IMGPlace").GetComponent<TMP_InputField>().text = "";
...
private void ProcessObjectSelection(ObjectID objectID)
{
    ...
    void updateObjectParameters()
    {
        ...
        uiObject = ObjectID.GetObjectByID(id);
        ...
        if (uiObject != null)
        {
            ...
            if (uiObject.GetComponent<Image>() != null)
            {
                if (float.TryParse(EditParametersPanel.transform.Find("TransparencyPanel/TransparencyPlace").GetComponent<TMP_InputField>().text, out float alphaValue))
                {
    ...
    public void objUp()
    {
        ...
        {
            uiObject.transform.SetSiblingIndex(uiObject.transform.GetSiblingIndex() + 1);
        }
    }
